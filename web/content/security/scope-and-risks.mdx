...
See [Lending asset scope](/docs/learn/lending-assets), [Multi-chain architecture](/docs/curate/multi-chain), and [Deferred / out of scope](/docs/security/deferred) for details.
...
Read the [adapter trust model](/docs/security/trust-model) and [adapter registry](/docs/build/adapter-registry).
...
Read [Compliance responsibility boundary](/docs/curate/compliance) before launching a permissioned market.
...
Read [RWA and tokenized equity support](/docs/curate/rwa-markets) and [Launch an RWA market](/docs/curate/rwa-markets).
...
Read [Liquidations](/docs/learn/liquidations) and [Async liquidation flow](/docs/curate/liquidation).
...
Read [Deferred / out of scope](/docs/security/deferred) for the reasons behind each decision.

## Next step

If these boundaries fit your use case, choose a workflow from [Start here](/docs). If you are reviewing protocol risk, continue to the [security model](/docs/security/model).
