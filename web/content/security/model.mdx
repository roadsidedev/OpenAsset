...
See [Adapter trust model](/docs/security/trust-model) in full. Treat as equally load-bearing as reentrancy protection during audit.

## Issuer insolvency

See [RWA § Issuer risk](/docs/curate/rwa-markets). Explicitly **not** a code-level problem — a documentation, disclosure, and legal (ToS) requirement.
...
Full checklist: [Security checklist](/docs/security/checklist).
