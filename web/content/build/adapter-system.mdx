...
The engine does not need to know *why* a price is untrusted — only whether to act on it. Untrusted prices feed the [circuit breaker](/docs/learn/circuit-breaker).
...
**Tiers:** Standard (no token), Soulbound ERC721, Transferable ERC721. Details: [Position adapters](/docs/learn/positions).
