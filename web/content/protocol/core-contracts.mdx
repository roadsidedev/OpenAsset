...
- Validate market configuration against the [Validation Matrix](/docs/protocol/validation-matrix)
- Deploy a new isolated `LendingMarket` instance
- Wire chosen adapters from the [Adapter Registry](/docs/protocol/adapter-registry)
...
See [Loan lifecycle](/docs/protocol/loan-lifecycle) for full state transitions.
