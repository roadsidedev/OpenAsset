...
Read the [validation matrix](/docs/protocol/validation-matrix) for the complete rules.
...
Read the [loan lifecycle](/docs/protocol/loan-lifecycle) and [async liquidation flow](/docs/guides/liquidation) for the complete state transitions.
...
Read the [protocol overview](/docs/protocol/overview) for the architecture and the [security model](/docs/protocol/security) for the implementation baseline.
