...
export default function PortfolioPage() {
  ...
  const totalCollateral = activeLoans.reduce((s: bigint, l: any) => s + BigInt(l.collateralAmount || 0), BigInt(0));
      ...
      <div className="min-h-screen">
        <main className="mx-auto max-w-7xl px-4 py-8 md:px-8 space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-4">
            {[1, 2, 3, 4].map((i) => <Skeleton key={i} className="h-28 rounded-2xl bg-muted" />)}
          </div>
        </main>
      </div>
    );
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm max-w-md">
            Connect your wallet to manage your portfolio, deposits, withdrawals, and settings.
          </p>
        </div>
      </div>
    );
            ...
            <div className="lg:col-span-8 p-6 rounded-3xl border border-border bg-card space-y-4">
              ...
              <div className="h-60 relative">
                <svg viewBox="0 0 600 200" className="w-full h-full" preserveAspectRatio="none">
                  ...
                  <path
                    d="M0,160 C60,140 120,150 180,120 C240,90 300,100 360,80 C420,60 480,70 540,50 C570,40 590,45 600,40 L600,200 L0,200 Z"
                    fill="url(#perfGradient)"
                  />
                  <path
                    d="M0,160 C60,140 120,150 180,120 C240,90 300,100 360,80 C420,60 480,70 540,50 C570,40 590,45 600,40"
                    fill="none" stroke="#A8D8FF" strokeWidth="2"
                  />
        ...
        {subTab === "config" && (
          <div className="p-6 rounded-3xl border border-border bg-card space-y-6 max-w-2xl">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-muted/50">
                <div>
                  <div className="font-bold text-foreground">Circuit Breaker Email & Push Alerts</div>
                  <div className="text-[10px] text-muted-foreground mt-0.5">
              ...
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-muted/50">
                <div>
                  <div className="font-bold text-foreground">Liquidation Alerts</div>
                  <div className="text-[10px] text-muted-foreground mt-0.5">
                    Get notified when loans approach liquidation thresholds
                  </div>
                </div>
                <input type="checkbox" defaultChecked className="w-4 h-4 accent-ice-500 rounded" />
              </div>
