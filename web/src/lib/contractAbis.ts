...
export const LENDING_MARKET_ABI = [
  ...
  'function reservedSettling() external view returns (uint256)',
  ...
  'function gracePeriodHours() external view returns (uint256)',
  'function enableHealthFactor() external view returns (bool)',
  'function healthFactorThreshold() external view returns (uint256)',
  'function cbConfig() external view returns (bool enabled, uint256 pauseThresholdBps, uint256 lookbackPeriodSeconds, uint256 resumeThresholdBps, uint256 cooldownSeconds)',
  'function pause() external',
  'function unpause() external',
  'function finalizeRedemptionSettlement(uint256 loanId) external',
