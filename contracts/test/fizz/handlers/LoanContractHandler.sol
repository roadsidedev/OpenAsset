...
abstract contract LoanContractHandler is Properties {
    ...
    function loanContract_initialize_clamped(address borrower_, uint256 collateralAmount_, uint256 tokenId_, uint256 principal_, uint256 interestAmount_, uint256 expiryTime_) public {
        ...
        loanContract_initialize(borrower_, collateralAmount_, tokenId_, principal_, interestAmount_, expiryTime_);
    }
    ...
    function loanContract_initialize(address borrower_, uint256 collateralAmount_, uint256 tokenId_, uint256 principal_, uint256 interestAmount_, uint256 expiryTime_) public asActor {
        // TODO: wire call — loanContract.initialize(borrower_, collateralAmount_, tokenId_, principal_, interestAmount_, expiryTime_);
    }
